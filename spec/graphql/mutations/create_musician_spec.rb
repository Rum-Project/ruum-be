...
RSpec.describe Types::QueryType do
  describe 'display musicians' do
    it 'can query a single musician' do
      Musician.create(id: 5, name: "Bruce Easley", email: "bruce.e@mail.com", phone: "7573830582")
      Musician.create(id: 6, name: "Bruce Isley", email: "bruce.i@mail.com", phone: "9573830582")
